<?php 
	...
	$strAccion = (isset($_POST['accion'])) ? $_POST['accion'] : 'abrirPersonajeRelaciones';

	// dependiendo de la acción de usuario se solicita una acción u otra al controlador
	switch ($strAccion) {	


		// se ha solicitado la acción buscarRelacionesPersonaje
		case 'buscarRelacionesPersonaje':
			$cp->buscarRelacionesPersonaje();
			break;			


		// se ha solicitado la acción crearPersonajeRelacion
		case 'crearPersonajeRelacion':
			$cp->crearPersonajeRelacion();
			break;	


		// se ha solicitado la acción eliminarPersonajeRelacion
		case 'eliminarPersonajeRelacion':
			$cp->eliminarPersonajeRelacion();
			break;	
