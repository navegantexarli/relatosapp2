<?php 
	...
	$strAccion = (isset($_POST['accion'])) ? $_POST['accion'] : 'abrirValoresPalabraClave';
	...
	switch ($strAccion) {
		...
		// se ha solicitado la acción buscarValoresPalabraClave
		case 'buscarValoresPalabraClave':
			$cpc->buscarValoresPalabraClave();
			break;


		// se ha solicitado la acción crearValorPalabraClave
		case 'crearValorPalabraClave':
			$cpc->crearValorPalabraClave();
			break;


		// se ha solicitado la acción actualizarValorPalabraClave
		case 'actualizarValorPalabraClave':
			$cpc->actualizarValorPalabraClave();
			break;			


		// se ha solicitado la acción eliminarValorPalabraClave
		case 'eliminarValorPalabraClave':
			$cpc->eliminarValorPalabraClave();
			break;			
